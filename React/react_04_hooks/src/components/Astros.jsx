...
const Astros = () =>{
    ...
    // Envia la información de la API a las cards utilizando .map sobre el array `astros`
    ...
    return(
        ...
        <>
        
            {
                ...
                // `astro` funciona como los elementos que se recorren en el array `astros` y .map recibe dichos elementos, más un index y una función llamada callback

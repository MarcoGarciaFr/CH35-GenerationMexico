...
public class Manager extends Employee {
	...
	/*
		...
		Requerimentos:
			...
			- Crear método para verificar la antiguedad y calcular el incremento salarial	
	...
	*/
	...
	// Método para calcular el salario con incremento (siempre que se cumpla la condicion)
	...
	// 5. toString. Para generar el toString y mandar a llamar los atributos de la superclase, debo seleccionar los getters de los atributos heredados. Después, puedo modificar el return según mi conveniencia
		...
		public String toString() {
			...
			return "Manager [ antiguedad = " 
			
			+ antiguedad + ", incremento = " 
			
			+ incremento + ", nombre = "
					
			+ getNombreCompleto() + ", id = " 

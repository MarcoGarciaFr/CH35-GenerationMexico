...
/*
	...
	Aquí si se pueden establecer los try-catch de la exepción que se definió en el método retirar
...
public class Cajero {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Simulamos nuevamnete el Scanner para retirar
			...
			// syso ctrl + space para el System.out.println
			
			// sysout ctrl + space para el System.out.println
